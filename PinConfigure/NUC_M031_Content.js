...
NUTOOL_PIN.g_cfg_gpios = [
	...
	{ f: ['PC.1:0', 'EBI_AD1:2', 'UART2_TXD:8', 'I2C0_SCL:9', 'PWM1_CH4:12', 'ACMP0_O:14', 'ADC0_ST:15']},
...
NUTOOL_PIN.g_cfg_gpiosDefines = [
	...
	{ f: ['PC.1', 'GPIO:SYS_GPC_MFPL_PC1MFP_GPIO@GPC_MFPL', 'EBI_AD1:SYS_GPC_MFPL_PC1MFP_EBI_AD1@GPC_MFPL', 'UART2_TXD:SYS_GPC_MFPL_PC1MFP_UART2_TXD@GPC_MFPL', 'I2C0_SCL:SYS_GPC_MFPL_PC1MFP_I2C0_SCL@GPC_MFPL', 'PWM1_CH4:SYS_GPC_MFPL_PC1MFP_PWM1_CH4@GPC_MFPL', 'ACMP0_O:SYS_GPC_MFPL_PC1MFP_ACMP0_O@GPC_MFPL', 'ADC0_ST:SYS_GPC_MFPL_PC1MFP_ADC0_ST@GPC_MFPL'] },
...
NUTOOL_PIN.g_cfg_unusedGPIO = {
	"M031FB0AE(TSSOP20)": {
		"ALL": ['ACMP0', 'ACMP1', 'EBI', 'PWM1', 'BPWM0', 'BPWM1', 'TM2', 'TM3', 'UART3', 'UART4', 'UART5', 'UART6', 'UART7', 'USCI0', 'USCI1', 'X32', 'USB', 'RTC', 'QSPI']
	},
	...
	"M031FC1AE(TSSOP20)": {
		"ALL": ['ACMP0', 'ACMP1', 'EBI', 'PWM1', 'BPWM0', 'BPWM1', 'UART3', 'UART4', 'UART5', 'UART6', 'UART7', 'USCI0', 'USCI1', 'X32', 'USB', 'RTC', 'QSPI']
	},
	"M031EC1AE(TSSOP28)": function () {
		return this["M031FC1AE(TSSOP20)"];
	},
	"M031TC1AE(QFN33)": {
		"ALL": ['ACMP0', 'ACMP1', 'EBI', 'PWM1', 'BPWM0', 'BPWM1', 'UART3', 'UART4', 'UART5', 'UART6', 'UART7', 'USCI0', 'USCI1', 'USB', 'RTC', 'QSPI']
	},
	"M031TD2AE(QFN33)": {
		"ALL": ['EBI', 'BPWM0', 'BPWM1', 'UART3', 'UART4', 'UART5', 'UART6', 'UART7', 'USCI1', 'USB', 'RTC', 'QSPI']
	},
	"M031TE3AE(QFN33)": {
		"ALL": ['EBI', 'INT5', 'BPWM0', 'BPWM1', 'UART3', 'UART4', 'UART5', 'UART6', 'UART7', 'USCI1', 'USB', 'RTC', 'QSPI']
	},
	"M031LC2AE(LQFP48)": function () {
		return this["M031TD2AE(QFN33)"];
	},
	"M031LD2AE(LQFP48)": function () {
		return this["M031TD2AE(QFN33)"];
	},
	"M031SC2AE(LQFP64)": function () {
		return this["M031TD2AE(QFN33)"];
	},
	...
	"M031LE3AE(LQFP48)": {
		"ALL": ['BPWM0', 'BPWM1', 'UART3', 'UART4', 'UART5', 'UART6', 'UART7', 'USCI1', 'USB', 'RTC', 'QSPI']
	},
	"M031SE3AE(LQFP64)": function () {
		return this["M031LE3AE(LQFP48)"];
	},
	"M032LE3AE(LQFP48)": {
		"ALL": ['BPWM0', 'BPWM1', 'UART3', 'UART4', 'UART5', 'UART6', 'UART7', 'USCI1', 'RTC', 'QSPI']
	},
	"M032SE3AE(LQFP64)": function () {
		return this["M032LE3AE(LQFP48)"];
	}
};
