...
NUTOOL_PIN.g_cfg_chips = [
	{ name: "AX58200", pkg: "HSBGA144" }
];

NUTOOL_PIN.g_cfg_pkgs = {
	"HSBGA144": [
		'PB.7', 'PB.8', 'AVSS', 'VREF', 'AVDD', 'PC.14', 'IO[23]', 'LDO_CAP', 'IO[21]', 'SCL', 'HSUSB_VDD12_CAP', 'HSUSB_D+',
		'PB.6', 'PB.5', 'PB.10', 'IO[26]', 'IO[25]', 'IO[24]', 'IO[22]', 'PH.9', 'SDA', 'PDI_EMU', 'HSUSB_ID', 'HSUSB_D-',
		'PB.4', 'PB.3', 'PB.9', 'PB.11', 'PB.14', 'VDD', 'VCCK', 'PH.8', 'IO[4]', 'RSTn', 'HSUSB_VBUS', 'HSUSB_VRES',
		'PB.2', 'PB.1', 'PB.13', 'PB.15', 'PB.12', 'VDD', 'VCCK', 'OE_EXT', 'TEST', 'PE.0', 'HSUSB_VSS', 'HSUSB_VDD33',
		'PB.0', 'SYNC_LATCH[1]', 'SYNC_LATCH[0]', 'SOF', 'OUTVLD', 'VDD', 'VCCK', 'VCC12A_PLL', 'RSTO', 'PE.7', 'PE.1', 'PE.2',
		'PA.10', 'PA.11', 'IO[2]', 'EOF', 'VSS', 'VSS', 'VSS', 'VSS', 'NC', 'PE.6', 'PE.4', 'PE.3',
		'PF.4', 'PA.9', 'PA.8', 'WD_TRIG', 'VSS', 'VSS', 'VSS', 'VSS', 'IO[1]', 'IO[17]', 'IO[19]', 'PE.5',
		'PF.5', 'PF.6', 'IO[27]', 'LAT_IN', 'RSET_BG', 'VCC3IO', 'VCC3IO', 'VCC3IO', 'IO[20]', 'IO[0]', 'IO[18]', 'VDDIO',
		'PF.2', 'IO[28]', 'IO[29]', 'PE.13', 'PC.8', 'PA.7', 'PA.5', 'PA.2', 'PA.0', 'P0.ACT', 'P1.ACT', 'IO[16]',
		'PF.3', 'EEP_DONE', 'IO[30]', 'PC.7', 'PC.6', 'PA.6', 'PA.4', 'PA.3', 'PA.1', 'nRESET', 'PC.1', 'PC.0',
		'LED_RUN', 'LED_ERR', 'P1.TXON', 'P1.RXIN', 'P1.SD', 'P0.TXON', 'P0.RXIN', 'P0.SD', 'XSCI', 'PF.1', 'PC.3', 'PC.2',
		'IO[31]', 'VCC33A', 'P1.TXOP', 'P1.RXIP', 'VCC33A', 'P0.TXOP', 'P0.RXIP', 'VCC33A', 'XSCO', 'PF.0', 'PC.5', 'PC.4'
	]
};
...
NUTOOL_PIN.g_cfg_gpiosDefines = [
	...
	{ f: ['PD.10', 'OPA2_P:SYS_GPD_MFPH_PD10MFP_OPA2_P@GPD_MFPH', 'EBI_nCS2:SYS_GPD_MFPH_PD10MFP_EBI_nCS2@GPD_MFPH', 'UART1_RXD:SYS_GPD_MFPH_PD10MFP_UART1_RXD@GPD_MFPH', 'CAN0_RXD:SYS_GPD_MFPH_PD10MFP_CAN0_RXD@GPD_MFPH', 'QEI0_B:SYS_GPD_MFPH_PD10MFP_QEI0_B@GPD_MFPH', 'INT7:SYS_GPD_MFPH_PD10MFP_INT7@GPD_MFPH'] },
	{ f: ['PD.11', 'OPA2_N:SYS_GPD_MFPH_PD11MFP_OPA2_N@GPD_MFPH', 'EBI_nCS1:SYS_GPD_MFPH_PD11MFP_EBI_nCS1@GPD_MFPH', 'UART1_TXD:SYS_GPD_MFPH_PD11MFP_UART1_TXD@GPD_MFPH', 'CAN0_TXD:SYS_GPD_MFPH_PD11MFP_CAN0_TXD@GPD_MFPH', 'QEI0_A:SYS_GPD_MFPH_PD11MFP_QEI0_A@GPD_MFPH', 'INT6:SYS_GPD_MFPH_PD11MFP_INT6@GPD_MFPH'] },
	{ f: ['PD.12', 'OPA2_O:SYS_GPD_MFPH_PD12MFP_OPA2_O@GPD_MFPH', 'EBI_nCS0:SYS_GPD_MFPH_PD12MFP_EBI_nCS0@GPD_MFPH', 'CAN1_RXD:SYS_GPD_MFPH_PD12MFP_CAN1_RXD@GPD_MFPH', 'UART2_RXD:SYS_GPD_MFPH_PD12MFP_UART2_RXD@GPD_MFPH', 'BPWM0_CH5:SYS_GPD_MFPH_PD12MFP_BPWM0_CH5@GPD_MFPH', 'QEI0_INDEX:SYS_GPD_MFPH_PD12MFP_QEI0_INDEX@GPD_MFPH', 'CLKO:SYS_GPD_MFPH_PD12MFP_CLKO@GPD_MFPH', 'EADC0_ST:SYS_GPD_MFPH_PD12MFP_EADC0_ST@GPD_MFPH', 'INT5:SYS_GPD_MFPH_PD12MFP_INT5@GPD_MFPH'] },
	...
	{ f: ['PD.14', 'EBI_nCS0:SYS_GPD_MFPH_PD14MFP_EBI_nCS0@GPD_MFPH', 'SPI3_I2SMCLK:SYS_GPD_MFPH_PD14MFP_SPI3_I2SMCLK@GPD_MFPH', 'SC1_nCD:SYS_GPD_MFPH_PD14MFP_SC1_nCD@GPD_MFPH', 'EPWM0_CH4:SYS_GPD_MFPH_PD14MFP_EPWM0_CH4@GPD_MFPH'] },
	{ f: ['PD.15'] },
	...
	{ f: ['PE.3', 'EBI_MCLK:SYS_GPE_MFPL_PE3MFP_EBI_MCLK@GPE_MFPL', 'SD0_DAT1:SYS_GPE_MFPL_PE3MFP_SD0_DAT1@GPE_MFPL', 'SPIM_MISO:SYS_GPE_MFPL_PE3MFP_SPIM_MISO@GPE_MFPL', 'SPI3_MISO:SYS_GPE_MFPL_PE3MFP_SPI3_MISO@GPE_MFPL', 'SC0_DAT:SYS_GPE_MFPL_PE3MFP_SC0_DAT@GPE_MFPL', 'USCI0_DAT0:SYS_GPE_MFPL_PE3MFP_USCI0_DAT0@GPE_MFPL', 'QEI0_A:SYS_GPE_MFPL_PE3MFP_QEI0_A@GPE_MFPL', 'EPWM0_CH4:SYS_GPE_MFPL_PE3MFP_EPWM0_CH4@GPE_MFPL', 'BPWM0_CH1:SYS_GPE_MFPL_PE3MFP_BPWM0_CH1@GPE_MFPL'] },
	...
	{ f: ['PE.14', 'EBI_AD8:SYS_GPE_MFPH_PE14MFP_EBI_AD8@GPE_MFPH', 'UART2_TXD:SYS_GPE_MFPH_PE14MFP_UART2_TXD@GPE_MFPH', 'CAN0_TXD:SYS_GPE_MFPH_PE14MFP_CAN0_TXD@GPE_MFPH', 'SD1_nCD:SYS_GPE_MFPH_PE14MFP_SD1_nCD@GPE_MFPH'] },
	...
	{ f: ['PG.0', 'EBI_ADR8:SYS_GPG_MFPL_PG0MFP_EBI_ADR8@GPG_MFPL', 'I2C0_SCL:SYS_GPG_MFPL_PG0MFP_I2C0_SCL@GPG_MFPL', 'I2C1_SMBAL:SYS_GPG_MFPL_PG0MFP_I2C1_SMBAL@GPG_MFPL', 'UART2_RXD:SYS_GPG_MFPL_PG0MFP_UART2_RXD@GPG_MFPL', 'CAN1_TXD:SYS_GPG_MFPL_PG0MFP_CAN1_TXD@GPG_MFPL', 'UART1_TXD:SYS_GPG_MFPL_PG0MFP_UART1_TXD@GPG_MFPL'] },
	{ f: ['PG.1', 'EBI_ADR9:SYS_GPG_MFPL_PG1MFP_EBI_ADR9@GPG_MFPL', 'SPI2_I2SMCLK:SYS_GPG_MFPL_PG1MFP_SPI2_I2SMCLK@GPG_MFPL', 'I2C0_SDA:SYS_GPG_MFPL_PG1MFP_I2C0_SDA@GPG_MFPL', 'I2C1_SMBSUS:SYS_GPG_MFPL_PG1MFP_I2C1_SMBSUS@GPG_MFPL', 'UART2_TXD:SYS_GPG_MFPL_PG1MFP_UART2_TXD@GPG_MFPL', 'CAN1_RXD:SYS_GPG_MFPL_PG1MFP_CAN1_RXD@GPG_MFPL', 'UART1_RXD:SYS_GPG_MFPL_PG1MFP_UART1_RXD@GPG_MFPL'] },
	...
	{ f: ['PG.5', 'EBI_nCS1:SYS_GPG_MFPL_PG5MFP_EBI_nCS1@GPG_MFPL', 'SPI3_SS:SYS_GPG_MFPL_PG5MFP_SPI3_SS@GPG_MFPL', 'SC1_PWR:SYS_GPG_MFPL_PG5MFP_SC1_PWR@GPG_MFPL', 'EPWM0_CH3:SYS_GPG_MFPL_PG5MFP_EPWM0_CH3@GPG_MFPL'] },
	{ f: ['PG.6', 'EBI_nCS2:SYS_GPG_MFPL_PG6MFP_EBI_nCS2@GPG_MFPL', 'SPI3_CLK:SYS_GPG_MFPL_PG6MFP_SPI3_CLK@GPG_MFPL', 'SC1_RST:SYS_GPG_MFPL_PG6MFP_SC1_RST@GPG_MFPL', 'EPWM0_CH2:SYS_GPG_MFPL_PG6MFP_EPWM0_CH2@GPG_MFPL'] },
	{ f: ['PG.7', 'EBI_nWRL:SYS_GPG_MFPL_PG7MFP_EBI_nWRL@GPG_MFPL', 'SPI3_MISO:SYS_GPG_MFPL_PG7MFP_SPI3_MISO@GPG_MFPL', 'SC1_DAT:SYS_GPG_MFPL_PG7MFP_SC1_DAT@GPG_MFPL', 'EPWM0_CH1:SYS_GPG_MFPL_PG7MFP_EPWM0_CH1@GPG_MFPL'] },
	{ f: ['PG.8', 'EBI_nWRH:SYS_GPG_MFPH_PG8MFP_EBI_nWRH@GPG_MFPH', 'SPI3_MOSI:SYS_GPG_MFPH_PG8MFP_SPI3_MOSI@GPG_MFPH', 'SC1_CLK:SYS_GPG_MFPH_PG8MFP_SC1_CLK@GPG_MFPH', 'EPWM0_CH0:SYS_GPG_MFPH_PG8MFP_EPWM0_CH0@GPG_MFPH'] },
	{ f: ['PG.9', 'EBI_AD0:SYS_GPG_MFPH_PG9MFP_EBI_AD0@GPG_MFPH', 'SD1_DAT3:SYS_GPG_MFPH_PG9MFP_SD1_DAT3@GPG_MFPH', 'SPIM_D2:SYS_GPG_MFPH_PG9MFP_SPIM_D2@GPG_MFPH', 'BPWM0_CH5:SYS_GPG_MFPH_PG9MFP_BPWM0_CH5@GPG_MFPH'] },
	{ f: ['PG.10', 'EBI_AD1:SYS_GPG_MFPH_PG10MFP_EBI_AD1@GPG_MFPH', 'SD1_DAT2:SYS_GPG_MFPH_PG10MFP_SD1_DAT2@GPG_MFPH', 'SPIM_D3:SYS_GPG_MFPH_PG10MFP_SPIM_D3@GPG_MFPH', 'BPWM0_CH4:SYS_GPG_MFPH_PG10MFP_BPWM0_CH4@GPG_MFPH'] },
	{ f: ['PG.11', 'EBI_AD2:SYS_GPG_MFPH_PG11MFP_EBI_AD2@GPG_MFPH', 'SD1_DAT1:SYS_GPG_MFPH_PG11MFP_SD1_DAT1@GPG_MFPH', 'SPIM_SS:SYS_GPG_MFPH_PG11MFP_SPIM_SS@GPG_MFPH', 'BPWM0_CH3:SYS_GPG_MFPH_PG11MFP_BPWM0_CH3@GPG_MFPH'] },
	{ f: ['PG.12', 'EBI_AD3:SYS_GPG_MFPH_PG12MFP_EBI_AD3@GPG_MFPH', 'SD1_DAT0:SYS_GPG_MFPH_PG12MFP_SD1_DAT0@GPG_MFPH', 'SPIM_CLK:SYS_GPG_MFPH_PG12MFP_SPIM_CLK@GPG_MFPH', 'BPWM0_CH2:SYS_GPG_MFPH_PG12MFP_BPWM0_CH2@GPG_MFPH'] },
	{ f: ['PG.13', 'EBI_AD4:SYS_GPG_MFPH_PG13MFP_EBI_AD4@GPG_MFPH', 'SD1_CMD:SYS_GPG_MFPH_PG13MFP_SD1_CMD@GPG_MFPH', 'SPIM_MISO:SYS_GPG_MFPH_PG13MFP_SPIM_MISO@GPG_MFPH', 'BPWM0_CH1:SYS_GPG_MFPH_PG13MFP_BPWM0_CH1@GPG_MFPH'] },
	{ f: ['PG.14', 'EBI_AD5:SYS_GPG_MFPH_PG14MFP_EBI_AD5@GPG_MFPH', 'SD1_CLK:SYS_GPG_MFPH_PG14MFP_SD1_CLK@GPG_MFPH', 'SPIM_MOSI:SYS_GPG_MFPH_PG14MFP_SPIM_MOSI@GPG_MFPH', 'BPWM0_CH0:SYS_GPG_MFPH_PG14MFP_BPWM0_CH0@GPG_MFPH'] },
	{ f: ['PG.15', 'SD1_nCD:SYS_GPG_MFPH_PG15MFP_SD1_nCD@GPG_MFPH', 'CLKO:SYS_GPG_MFPH_PG15MFP_CLKO@GPG_MFPH', 'EADC0_ST:SYS_GPG_MFPH_PG15MFP_EADC0_ST@GPG_MFPH'] },

	{ f: ['PH.0', 'EBI_ADR7:SYS_GPH_MFPL_PH0MFP_EBI_ADR7@GPH_MFPL', 'UART5_TXD:SYS_GPH_MFPL_PH0MFP_UART5_TXD@GPH_MFPL', 'TM0_EXT:SYS_GPH_MFPL_PH0MFP_TM0_EXT@GPH_MFPL'] },
	{ f: ['PH.1', 'EBI_ADR6:SYS_GPH_MFPL_PH1MFP_EBI_ADR6@GPH_MFPL', 'UART5_RXD:SYS_GPH_MFPL_PH1MFP_UART5_RXD@GPH_MFPL', 'TM1_EXT:SYS_GPH_MFPL_PH1MFP_TM1_EXT@GPH_MFPL'] },
	{ f: ['PH.2', 'EBI_ADR5:SYS_GPH_MFPL_PH2MFP_EBI_ADR5@GPH_MFPL', 'UART5_nRTS:SYS_GPH_MFPL_PH2MFP_UART5_nRTS@GPH_MFPL', 'UART4_TXD:SYS_GPH_MFPL_PH2MFP_UART4_TXD@GPH_MFPL', 'I2C0_SCL:SYS_GPH_MFPL_PH2MFP_I2C0_SCL@GPH_MFPL', 'TM2_EXT:SYS_GPH_MFPL_PH2MFP_TM2_EXT@GPH_MFPL'] },
	{ f: ['PH.3', 'EBI_ADR4:SYS_GPH_MFPL_PH3MFP_EBI_ADR4@GPH_MFPL', 'SPI1_I2SMCLK:SYS_GPH_MFPL_PH3MFP_SPI1_I2SMCLK@GPH_MFPL', 'UART5_nCTS:SYS_GPH_MFPL_PH3MFP_UART5_nCTS@GPH_MFPL', 'UART4_RXD:SYS_GPH_MFPL_PH3MFP_UART4_RXD@GPH_MFPL', 'I2C0_SDA:SYS_GPH_MFPL_PH3MFP_I2C0_SDA@GPH_MFPL', 'TM3_EXT:SYS_GPH_MFPL_PH3MFP_TM3_EXT@GPH_MFPL'] },
...
NUTOOL_PIN.decidepackageNumber = function (given_partNumber_package) {
	...
	case 'HSBGA144':
		NUTOOL_PIN.g_packageNumberIndex = "HSBGA144";
		break;
	}
