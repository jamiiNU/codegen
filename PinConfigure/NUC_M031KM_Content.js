...
NUTOOL_PIN.g_cfg_pkgs = {
	...
	"QFN33": [
		...
		'PF.0','PF.1','PC.5','PC.4','PC.3','PC.2','PC.1','PC.0',
	...
	"LQFP48": [
		...
		'PF.15','nRESET',
		'PF.0','PF.1','PC.5','PC.4','PC.3','PC.2','PC.1','PC.0','NC','NC',
		'NC','NC',
...
NUTOOL_PIN.g_cfg_gpios = [
	{ f: ['PA.0:0', 'QSPI0_MOSI0:3', 'SPI0_MOSI:4', 'UART0_RXD:7', 'BPWM0_CH0:12']},
	{ f: ['PA.1:0', 'QSPI0_MISO0:3', 'SPI0_MISO:4', 'UART0_TXD:7', 'USCI1_CLK:11', 'BPWM0_CH1:12']},
	{ f: ['PA.2:0', 'QSPI0_CLK:3', 'SPI0_CLK:4', 'USCI1_DAT0:11', 'BPWM0_CH2:12']},
	{ f: ['PA.3:0', 'QSPI0_SS:3', 'SPI0_SS:4', 'USCI1_DAT1:11', 'BPWM0_CH3:12', 'CLKO:14']},
	{ f: ['PA.4:0', 'QSPI0_MOSI1:3', 'SPI0_I2SMCLK:4', 'UART0_nRTS:7', 'UART0_RXD:8', 'BPWM0_CH4:12']},
	{ f: ['PA.5:0', 'QSPI0_MISO1:3', 'UART0_nCTS:7', 'UART0_TXD:8', 'BPWM0_CH5:12']},
	{ f: ['PA.6:0', 'UART0_RXD:7', 'BPWM1_CH3:12', 'TM3:14', 'INT0:15']},
	{ f: ['PA.7:0', 'UART0_TXD:7', 'BPWM1_CH2:12', 'TM2:14', 'INT1:15']},
	{ f: ['PA.8:0', 'USCI0_CTL1:6', 'BPWM0_CH3:9', 'TM3_EXT:13', 'INT4:15']},
	{ f: ['PA.9:0', 'USCI0_DAT1:6', 'BPWM0_CH2:9', 'TM2_EXT:13']},
	...
	{ f: ['PB.0:0', 'ADC0_CH0:1', 'SPI0_I2SMCLK:8', 'QSPI0_MOSI1:10']},
	{ f: ['PB.1:0', 'ADC0_CH1:1', 'USCI1_CLK:8', 'QSPI0_MISO1:10']},
	{ f: ['PB.2:0', 'ADC0_CH2:1', 'USCI1_DAT0:8', 'TM3:14', 'INT3:15']},
	{ f: ['PB.3:0', 'ADC0_CH3:1', 'USCI1_DAT1:8', 'TM2:14', 'INT2:15']},
	{ f: ['PB.4:0', 'ADC0_CH4:1', 'USCI1_CTL1:8', 'TM1:14', 'INT1:15']},
	{ f: ['PB.5:0', 'ADC0_CH5:1', 'USCI1_CTL0:8', 'TM0:14', 'INT0:15']},
	{ f: ['PB.6:0', 'ADC0_CH6:1', 'USCI1_DAT1:4', 'BPWM1_CH5:10', 'INT4:13']},
	{ f: ['PB.7:0', 'ADC0_CH7:1', 'USCI1_DAT0:4', 'BPWM1_CH4:10', 'INT5:13']},
	{ f: ['PB.8:0']},
	{ f: ['PB.9:0']},
	{ f: ['PB.10:0']},
	{ f: ['PB.11:0']},
	{ f: ['PB.12:0', 'ADC0_CH12:1', 'SPI0_MOSI:4', 'USCI0_CLK:5', 'UART0_RXD:6', 'BPWM0_CH0:12', 'TM3_EXT:13']},
	{ f: ['PB.13:0', 'ADC0_CH13:1', 'SPI0_MISO:4', 'USCI0_DAT0:5', 'UART0_TXD:6', 'BPWM0_CH1:12', 'TM2_EXT:13']},
	{ f: ['PB.14:0', 'ADC0_CH14:1', 'SPI0_CLK:4', 'USCI0_DAT1:5', 'UART0_nRTS:6', 'BPWM1_CH5:9', 'BPWM0_CH2:12', 'TM1_EXT:13', 'CLKO:14']},
	{ f: ['PB.15:0', 'ADC0_CH15:1', 'SPI0_SS:4', 'USCI0_CTL1:5', 'UART0_nCTS:6', 'BPWM1_CH4:9', 'BPWM0_CH3:12', 'TM0_EXT:13']},

	{ f: ['PC.0:0', 'QSPI0_MOSI0:4', 'BPWM1_CH3:11', 'BPWM0_CH4:13']},
	{ f: ['PC.1:0', 'QSPI0_MISO0:4', 'BPWM1_CH2:11', 'BPWM0_CH5:13', 'ADC0_ST:15']},
	{ f: ['PC.2:0', 'QSPI0_CLK:4']},
	{ f: ['PC.3:0', 'QSPI0_SS:4']},
	{ f: ['PC.4:0', 'QSPI0_MOSI1:4']},
	{ f: ['PC.5:0', 'QSPI0_MISO1:4']},
	{ f: ['PC.6:0']},
	{ f: ['PC.7:0']},
	{ f: ['PC.8:0']},
	{ f: ['PC.9:0']},
	...
	{ f: ['PC.12:0']},
	{ f: ['PC.13:0']},
	{ f: ['PC.14:0', 'SPI0_I2SMCLK:4', 'USCI0_CTL0:5', 'QSPI0_CLK:6', 'TM1:13']},
	{ f: ['PC.15:0']},
	...
	{ f: ['PF.0:0', 'UART0_TXD:4', 'BPWM1_CH0:12', 'BPWM0_CH5:13', 'ICE_DAT:14']},
	{ f: ['PF.1:0', 'UART0_RXD:4', 'BPWM1_CH1:12', 'BPWM0_CH4:13', 'ICE_CLK:14']},
	{ f: ['PF.2:0', 'UART0_RXD:3', 'QSPI0_CLK:5', 'BPWM1_CH1:11', 'USCI1_CTL1:12']},
	{ f: ['PF.3:0', 'UART0_TXD:3', 'BPWM1_CH0:11', 'USCI1_CTL0:12']},
	{ f: ['PF.4:0', 'QSPI0_MOSI1:3', 'BPWM0_CH5:8']},
	{ f: ['PF.5:0', 'QSPI0_MISO1:3', 'BPWM0_CH4:8', 'ADC0_ST:11']},
	{ f: ['PF.6:0']},
	{ f: ['PF.7:0']},
	{ f: ['PF.8:0']},
	{ f: ['PF.9:0']},
...
NUTOOL_PIN.g_cfg_unusedGPIO = {
	"M032FC1AE(TSSOP20)": {
		"ALL": ["ACMP0", "ACMP1", "EBI", "I2C0", "I2C1", "PWM0", "PWM1", "BPWM1", "TM2", "TM3", "UART1", "UART2", "UART3", "UART4", "UART5", "UART6", "UART7", "USCI0", "QSPI0"]
	},
	"M032EC1AE(TSSOP28)": function () {
		return this["M032FC1AE(TSSOP20)"];
	},
	"M032TC1AE(QFN33)": function () {
		return this["M032FC1AE(TSSOP20)"];
	},
	"M032TD2AE(QFN33)": {
		"ALL": ["ACMP0", "ACMP1", "EBI", "I2C0", "I2C1", "PWM0", "PWM1", "UART1", "UART2", "UART3", "UART4", "UART5", "UART6", "UART7"]
	},
	"M032LC2AE(LQFP48)": function () {
		return this["M032TD2AE(QFN33)"];
	},
	"M032LD2AE(LQFP48)": function () {
		return this["M032TD2AE(QFN33)"];
	},
	"M030FD2AE(TSSOP20)": {
		"ALL": ["ACMP0", "ACMP1", "EBI", "I2C0", "I2C1", "PWM0", "PWM1", "UART1", "UART2", "UART3", "UART4", "UART5", "UART6", "UART7", "USB"]
	},
	"M030TD2AE(QFN33)": function () {
		return this["M030FD2AE(TSSOP20)"];
	},
	"M030LD2AE(LQFP48)": function () {
		return this["M030FD2AE(TSSOP20)"];
	}
};
...
NUTOOL_PIN.decidepackageNumber = function (given_partNumber_package) {
	...
	case 'TSSOP20':
		if (partNumber === "M030FD2AE") {
			NUTOOL_PIN.g_packageNumberIndex = "TSSOP20";
		}
		else {
			NUTOOL_PIN.g_packageNumberIndex = "TSSOP20(USB1.1)";
		}
		break;
	case 'TSSOP28':
		NUTOOL_PIN.g_packageNumberIndex = "TSSOP28(USB1.1)";
		break;
	case 'QFN33':
		if (partNumber === "M030TD2AE") {
			NUTOOL_PIN.g_packageNumberIndex = "QFN33";
		}
		else {
			NUTOOL_PIN.g_packageNumberIndex = "QFN33(USB1.1)";
		}
		break;
	default:// 'LQFP48'
		if (partNumber === "M030LD2AE") {
			NUTOOL_PIN.g_packageNumberIndex = "LQFP48";
		}
		else {
			NUTOOL_PIN.g_packageNumberIndex = "LQFP48(USB1.1)";
		}
		break;
	}
