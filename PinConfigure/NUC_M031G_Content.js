...
NUTOOL_PIN.g_cfg_gpios = [
	...
	{ f: ['PA.10:0', 'ACMP1_P0:1', 'EBI_nWR:2', 'USCI0_DAT0:6', 'BPWM0_CH1:9', 'TM1_EXT:13']},
	...
	{ f: ['PB.8:0', 'ADC0_CH8:1', 'EBI_ADR19:2', 'USCI1_CLK:4', 'UART0_RXD:5', 'UART1_nRTS:6', 'BPWM1_CH3:10']},
	{ f: ['PB.9:0', 'ADC0_CH9:1', 'EBI_ADR18:2', 'USCI1_CTL1:4', 'UART0_TXD:5', 'UART1_nCTS:6', 'BPWM1_CH2:10']},
	...
	{ f: ['PC.6:0', 'EBI_AD8:2', 'UART4_RXD:5', 'UART0_nRTS:7', 'PWM1_CH3:11', 'BPWM1_CH1:12', 'TM1:14', 'INT2:15']},
	{ f: ['PC.7:0', 'EBI_AD9:2', 'UART4_TXD:5', 'UART0_nCTS:7', 'PWM1_CH2:11', 'BPWM1_CH0:12', 'TM0:14', 'INT3:15']},
	{ f: ['PC.8:0', 'EBI_ADR16:2', 'I2C0_SDA:4', 'UART4_nCTS:5', 'UART1_RXD:8', 'PWM1_CH1:11', 'BPWM1_CH4:12']},
	{ f: ['PC.9:0', 'EBI_ADR7:2', 'UART3_RXD:7', 'PWM1_CH3:12']},
	{ f: ['PC.10:0', 'EBI_ADR6:2', 'UART3_TXD:7', 'PWM1_CH2:12']},
	{ f: ['PC.11:0', 'EBI_ADR5:2', 'UART0_RXD:3', 'I2C0_SDA:4', 'PWM1_CH1:12', 'ACMP1_O:14']},
	{ f: ['PC.12:0', 'EBI_ADR4:2', 'UART0_TXD:3', 'I2C0_SCL:4', 'PWM1_CH0:12', 'ACMP0_O:14']},
	...
	{ f: ['PD.8:0', 'EBI_AD6:2', 'UART2_nRTS:4']},
	{ f: ['PD.9:0', 'EBI_AD7:2', 'UART2_nCTS:4']},
	...
	{ f: ['PE.2:0', 'EBI_ALE:2', 'USCI0_CLK:7', 'PWM0_CH5:12', 'BPWM0_CH0:13']},
	{ f: ['PE.3:0', 'EBI_MCLK:2', 'USCI0_DAT0:7', 'PWM0_CH4:12', 'BPWM0_CH1:13']},
	{ f: ['PE.4:0', 'EBI_nWR:2', 'USCI0_DAT1:7', 'PWM0_CH3:12', 'BPWM0_CH2:13']},
	{ f: ['PE.5:0', 'EBI_nRD:2', 'USCI0_CTL1:7', 'PWM0_CH2:12', 'BPWM0_CH3:13']},
	...
	{ f: ['PE.14:0', 'EBI_AD8:2', 'UART2_TXD:3']},
	{ f: ['PE.15:0', 'EBI_AD9:2', 'UART2_RXD:3']},
...
NUTOOL_PIN.g_cfg_unusedGPIO = {
	...
	"M031SG6AE(LQFP64)": function () {
		return this["M031LG6AE(LQFP48)"];
	},
	"M031KG6AE(LQFP128)": function () {
		return this["M031LG6AE(LQFP48)"];
	},
	"M031LG8AE(LQFP48)": function () {
		return this["M031LG6AE(LQFP48)"];
	},
	"M031SG8AE(LQFP64)": function () {
		return this["M031LG6AE(LQFP48)"];
	},
	"M031KG8AE(LQFP128)": function () {
		return this["M031LG6AE(LQFP48)"];
	},
	"M032LG6AE(LQFP48)": {
		"ALL": ["UART6", "UART7"]
	},
	"M032SG6AE(LQFP64)": function () {
		return this["M032LG6AE(LQFP48)"];
	},
	"M032KG6AE(LQFP128)": function () {
		return this["M032LG6AE(LQFP48)"];
	},
	"M032LG8AE(LQFP48)": function () {
		return this["M032LG6AE(LQFP48)"];
	},
	"M032SG8AE(LQFP64)": function () {
		return this["M032LG6AE(LQFP48)"];
	},
	"M032KG8AE(LQFP128)": function () {
		return this["M032LG6AE(LQFP48)"];
	},
	"M032BTAG8AN(QFN68)": {
