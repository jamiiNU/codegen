 ...
 *
 * $Date: 2011-02-09 01:17:14 +0200 (??, 09 ?ев? 2011) $
 * $Revision: 236 $
 */
	...
	$.jstree.plugin("themes", {
		__init : function () { 
			this.get_container()
				.bind("init.jstree", $.proxy(function () {
						...
						this.data.themes.jstree_ins = true;
						if(typeof s.jstree_ins !== 'undefined') {
							this.data.themes.jstree_ins = s.jstree_ins;
						}
		...
		_fn : {
			set_theme : function (theme_name, theme_url) {
				...
				if(!this.data.themes.jstree_ins) { this.hide_jstree_ins(); }
				this.__callback();
			},
			...
			hide_jstree_ins	: function () { this.get_container().children("ul").addClass("jstree-no-ins"); }
		}
	});
	...
	$.jstree.plugin("checkbox", {
		...
		_fn : {
			...
			_prepare_checkboxes: function(obj) {
				...
				obj.each(function() {
					var t = $(this);
					var c = t.is("li") && t.hasClass("jstree-checked") ? "jstree-checked" : "jstree-unchecked";
				...
				else { this._recursive_repair(obj); }
			},
			_recursive_repair: function(obj) {
				var _this = this;
				var children = obj.find("> ul > li");

				if (children.length > 0) {
					children.each(function(){_this._recursive_repair($(this))});
