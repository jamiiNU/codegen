...
#if (NUCODEGEN_CLK||NUCODEGEN_SYS)
#if (NUCODEGEN_CLK_CLKFAIL_INT_ENABLE||NUCODEGEN_SYS_IRCTIEN_INT_EN)
...
#endif /* NUCODEGEN_CLK_CLKFAIL_INT_ENABLE || NUCODEGEN_SYS_IRCTIEN_INT_EN */
#endif /* NUCODEGEN_CLK || NUCODEGEN_SYS */
