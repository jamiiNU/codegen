...
void GPIO_Init()
{
    ...
    GPIO_CLR_DEBOUNCE_ICLKON(PA);	/* NUC1262 parameter is useless */
#endif
...
#if (NUCODEGEN_GPIO_PA || NUCODEGEN_GPIO_PB)
#if (NUCODEGEN_GPIO_PA_INT||NUCODEGEN_GPIO_PB_INT)
	/* NVIC enable PA and PB interrupt */
    NVIC_EnableIRQ(GPAB_IRQn);
#endif
#endif

#if (NUCODEGEN_GPIO_PC || NUCODEGEN_GPIO_PD || NUCODEGEN_GPIO_PF)
#if (NUCODEGEN_GPIO_PC_INT||NUCODEGEN_GPIO_PD_INT||NUCODEGEN_GPIO_PF_INT)
	/* NVIC enable PC, PD and PF interrupt */
    NVIC_EnableIRQ(GPCDF_IRQn);
#endif
#endif

#if (NUCODEGEN_GPIO_PA || NUCODEGEN_GPIO_PB || NUCODEGEN_GPIO_PC || NUCODEGEN_GPIO_PF)
	...
	/* NVIC enable EINT0, EINT2 and EINT4 interrupt */
    NVIC_EnableIRQ(EINT024_IRQn);
#endif
#endif

#if (NUCODEGEN_GPIO_PA || NUCODEGEN_GPIO_PB || NUCODEGEN_GPIO_PC || NUCODEGEN_GPIO_PD ||NUCODEGEN_GPIO_PF)
	...
	/* NVIC enable EINT1, EINT3 and EINT5 interrupt */
