(function($) {
	...
	test("Single Test", function() {
		var	testElement = S('#field1_sub0 input[name=group1_Uart1Hidden]'),
			observableElement = S('#field1_sub0 select[name=group1___RCC_CFGR_VAL_18_21]');
	...
	test("Single Test", function() {
		var	testElement = S('#field1_sub0 input[name=group1_RadioHidden]'),
			observableElement = S('#field1_sub0 input:radio[name=group1_UART0BaudrateRadio]'),
			observableCheckedElement = S('#field1_sub0 input:radio[name=group1_UART0BaudrateRadio]:checked');;
	...
	test("Single Test", function() {
		var	testElement = S('#field1_sub0 input[name=group1_CheckBoxHidden]'),
	...
	test("Single Test", function() {
		...
		var	testElement = S('#field1_sub0 input[name=group1_CheckBoxBooleanHidden]'),
			observableElement = S('#field1_sub0 div[name=group1_UART1EnableINTCheckboxBoolean]');
	...
	test("Single Test", function() {
		var testElement = S('#field1_sub0 input[name=group1_MultipleSelectHidden]'),
			observableElement = S('#field1_sub0 select[name=group1_UART1DisableINTMultipleSelect]');
	...
	test("NUC_ANY Test", function() {
		var testElement = S('#field1_sub0 input[name=group1_MultipleSelectHidden1]'),
			observableElement = S('#field1_sub0 select[name=group1_TIMER0TriggerTargetMultipleSelect]');
	...
	test("Single Test", function() {
		var testElement = S('#field1_sub0 input[name=group1_IntegerHidden]'),
			observableElement = S('#field1_sub0 input[name=group1_UART1BaudrateInteger]');
	...
	test("Single Test", function() {
		var testElement = S('#field1_sub0 input[name=group1_HexTextHidden]'),
			observableElement = S('#field1_sub0 input[name=group1_Timer0InputHexText]');
