...
#if NUCODEGEN_BPWM0
#if (((NUCODEGEN_BPWM0_CH0_INT_SEL) & 0x0F) \
  || ((NUCODEGEN_BPWM0_CH1_INT_SEL) & 0x0F) \
  || ((NUCODEGEN_BPWM0_CH2_INT_SEL) & 0x0F) \
  || ((NUCODEGEN_BPWM0_CH3_INT_SEL) & 0x0F) \
  || ((NUCODEGEN_BPWM0_CH4_INT_SEL) & 0x0F) \
  || ((NUCODEGEN_BPWM0_CH5_INT_SEL) & 0x0F) \
  || ((NUCODEGEN_BPWM0_CH0_CAP_INT_SEL) & 0x03) \
  || ((NUCODEGEN_BPWM0_CH1_CAP_INT_SEL) & 0x03) \
  || ((NUCODEGEN_BPWM0_CH2_CAP_INT_SEL) & 0x03) \
  || ((NUCODEGEN_BPWM0_CH3_CAP_INT_SEL) & 0x03) \
  || ((NUCODEGEN_BPWM0_CH4_CAP_INT_SEL) & 0x03) \
  || ((NUCODEGEN_BPWM0_CH5_CAP_INT_SEL) & 0x03)) 

void BPWM0_IRQHandler(void)
{

#if ((NUCODEGEN_BPWM0_CH0_INT_SEL) & 1)
...
#if ((NUCODEGEN_BPWM0_CH0_INT_SEL) & 2)
...
#endif // NUCODEGEN_BPWM0_CHx_INT_SEL || NUCODEGEN_BPWM0_CHx_CAP_INT_SEL

#endif //NUCODEGEN_BPWM0

#if NUCODEGEN_BPWM1

#if (((NUCODEGEN_BPWM1_CH0_INT_SEL) & 0x0F) \
  || ((NUCODEGEN_BPWM1_CH1_INT_SEL) & 0x0F) \
  || ((NUCODEGEN_BPWM1_CH2_INT_SEL) & 0x0F) \
  || ((NUCODEGEN_BPWM1_CH3_INT_SEL) & 0x0F) \
  || ((NUCODEGEN_BPWM1_CH4_INT_SEL) & 0x0F) \
  || ((NUCODEGEN_BPWM1_CH5_INT_SEL) & 0x0F) \
  || ((NUCODEGEN_BPWM1_CH0_CAP_INT_SEL) & 0x03) \
  || ((NUCODEGEN_BPWM1_CH1_CAP_INT_SEL) & 0x03) \
  || ((NUCODEGEN_BPWM1_CH2_CAP_INT_SEL) & 0x03) \
  || ((NUCODEGEN_BPWM1_CH3_CAP_INT_SEL) & 0x03) \
  || ((NUCODEGEN_BPWM1_CH4_CAP_INT_SEL) & 0x03) \
  || ((NUCODEGEN_BPWM1_CH5_CAP_INT_SEL) & 0x03)) 
...
#endif // NUCODEGEN_BPWM1_CHx_INT_SEL || NUCODEGEN_BPWM1_CHx_CAP_INT_SEL
