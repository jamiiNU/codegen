...
#if (NUCODEGEN_UART4_FUNCSEL_SEL == NUCODEGEN_UART4_FUNCSEL_UART || NUCODEGEN_UART4_FUNCSEL_SEL == NUCODEGEN_UART4_FUNCSEL_SINGLE_WIRE )
#if (NUCODEGEN_UART4_INT_EN || NUCODEGEN_UART4_SW_INT_EN )
void UART4_IRQHandler(void)
{
    ...
    if (u32IntSts & UART_INTSTS_RLSIF_Msk)
    {
        ...
        u8InChar = UART4->DAT; // read out data
        printf("\n Error Data is '0x%x' \n", u8InChar);
...
#if (NUCODEGEN_UART4_FUNCSEL_SEL == NUCODEGEN_UART4_FUNCSEL_SINGLE_WIRE)
    if (u32IntSts & UART_INTSTS_SWBEINT_Msk)
    {
        printf("Single-wire Bit Error Detection \n");
...
//    }
#if ( NUCODEGEN_UART4_WKDAT_EN && NUCODEGEN_UART4_WAKEUP_INT_EN )
    /* UART Wake-up Interrupt  */
    if (u32IntSts & UART_INTSTS_WKIF_Msk)
    {
        printf("\n UART Wake-Up ");
...
#endif //NUCODEGEN_UART4_RS485_INT_EN
