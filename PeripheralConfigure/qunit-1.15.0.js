...
//notify headerGenerator of the failure result
function notifyHeaderGenerator() {
	// notify headerGenerator of the failure result
	$.ajax({
		...
		success: function(data) {
			ok(true, 'the tester notified the PythonApp of the result result');
		},
		error: function(xhr, status, error) {
			var errorMessage = xhr.status;
			showErrorMessage('the tester failed to notify the PythonApp/' + errorMessage);
		}
	});
}
